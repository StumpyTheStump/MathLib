...
void Matrix3::setScaled(float a_x, float a_y, float a_z, float b_x, float b_y, float b_z, float c_x, float c_y, float c_z)
{
	xAxis = { a_x, 0, 0 };
	yAxis = { 0, b_y, 0 };
	zAxis = { 0, 0, c_z };
...
void Matrix3::scale(float a_x, float a_y, float a_z, float b_x, float b_y, float b_z, float c_x, float c_y, float c_z)
{
	Matrix3 m;
	m.setScaled(a_x, a_y, a_z, b_x, b_y, b_z, c_x, c_y, c_z);
...
{
	Matrix3 m;
	m.setScaled(vec.m_x, 0, 0, 0, vec.m_y, 0, 0, 0, vec.m_z);
